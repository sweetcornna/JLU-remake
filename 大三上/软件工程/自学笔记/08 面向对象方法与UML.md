...
笔记所附的示意图：用例视图画在正中间，旁边标"行为"；左上逻辑视图标"词汇、功能"；右上实现视图标"系统装配、配置管理"；左下进程视图标"性能、可伸缩性、吞吐量"；右下实施视图标"系统拓扑、分布、交付、安装"。几个视图里关注结构性问题的是逻辑视图（和面向对象测试题的答案一致）。
...
| 图标（笔记的图） | 圆，底部贴一条横线 | 圆，左边用一小段横线连着一根竖线 | 圆，顶上带一个小箭头 |
